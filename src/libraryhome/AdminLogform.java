...
public class AdminLogform extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPasswordField2.setFont(new java.awt.Font("Yu Gothic Medium", 0, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        adminDashboard.setVisible(true); // display AdminDashboard
        dispose(); // close the current frame (AdminLogform)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminLogform.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminLogform().setVisible(true);
            }
        });
    }
